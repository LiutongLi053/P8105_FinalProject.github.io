...
html, body {
  ...
  background-color: #f3f4f6 !important;  /* 想要的浅灰 */
}

/* leonids / prettydoc 可能加白底的容器，统统改成透明或浅灰 */
body > div,
.main-container,
.page,
.page-header,
div#content {
  background-color: #f3f4f6 !important;  /* 也可以改成 transparent */
  box-shadow: none !important;
  border: none !important;
}

/* 你原本想要的全宽 main-container 保留 */
.main-container {
...
<div class="fullscreen-bg">
  <div class="bg-title">Energy Insecurity and Mental Health</div>
</div>
<br>
<br>
<br>
...
<ul>
<li><strong>Objective:</strong> To investigate the relationship between electricity insecurity and public mental health.</li>
...
<li><strong>Key variables:</strong> Energy insecurity conditions and population mental health outcomes.</li>
...
<li><strong>Focus:</strong> understand whether and how energy insecurity contributes to poorer health outcomes, and which variables most strongly influence these relationships.</li>
  ...
  <a href="model.html" style="color:#3498db; font-weight:600; text-decoration:none;">
    Learn More →
  </a>
</p>
</div>
...
<div class="card-content">
<p>The final report presents a clear narrative of our project, summarizing the motivation, methods, results, and key insights that link energy insecurity to mental health outcomes across the U.S.</p>
<p style="text-align:right; margin-top:15px;">
  <a href="report.html" style="color:#3498db; font-weight:600; text-decoration:none;">
    Learn More →
  </a>
</p>
...
<p style="text-align:right; margin-top:15px;">
  <a href="result.html" style="color:#3498db; font-weight:600; text-decoration:none;">
    Learn More →
  </a>
</p>
</div>
