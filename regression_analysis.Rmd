...
$$ \text{mean_glth} = -5.635  + 0.556\cdot\text{mean_mhlth}
- 0.115 \cdot \text{mean_sleep}
+ 0.226 \cdot \text{mean_lpa}
+ 0.744 \cdot \text{mean_diabetes}
+ 13.841 \cdot \text{EI_proportion}
- 2.102 \cdot \text{PO_proportion}
$$
